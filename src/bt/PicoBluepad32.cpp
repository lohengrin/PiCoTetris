...
namespace Bluepad32
{
    PicoBluepad32::PicoBluepad32() : _prevConnectedControllers(0), _controllers(), _onConnect(), _onDisconnect() {}

    const char *PicoBluepad32::firmwareVersion() const
    {
        return "Bluepad32 for Pico v" UNI_VERSION;
    }

    void PicoBluepad32::update()
    {
    ...
    void PicoBluepad32::forgetBluetoothKeys()
    {
        uni_bluetooth_del_keys_safe();
    }

    void PicoBluepad32::enableNewBluetoothConnections(bool enabled)
    {
        uni_bluetooth_enable_new_connections_safe(enabled);
    }

    void PicoBluepad32::setup(const GamepadCallback &onConnect, const GamepadCallback &onDisconnect)
    {
